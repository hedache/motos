        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Dni = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false),
                    Placa = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Registries_Persons_PersonId",
                        column: x => x.PersonId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUsers_Registries_RegistryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_RegistryId",
                table: "AspNetUsers",
                column: "RegistryId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Registries_PersonId",
                table: "Registries",
                column: "PersonId");

            migrationBuilder.CreateIndex(
                name: "IX_Registries_Placa",
                table: "Registries",
                column: "Placa",
                unique: true);
